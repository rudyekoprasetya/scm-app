<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Buat Purchase Order') }}</h2>
    </x-slot>
                    ...
                    <form action="{{ route('purchase-orders.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input name="expected_date" type="date" value="{{ old('expected_date') }}" class="w-full mt-1" />
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('purchase-orders.index') }}"><x-secondary-button type="button">Batal</x-secondary-button></a>
                        </div>
                    </form>
                </div>
            </div>
